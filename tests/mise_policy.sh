...
assert_contains .pre-commit-config.yaml 'entry: mise run lint'
assert_contains .pre-commit-config.yaml 'entry: mise run test'
...
assert_contains pyproject.toml 'ruff'
